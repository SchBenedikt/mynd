...
const COPY = {
  ...
  nl: { signIn:'Inloggen', register:'Registreren', create:'Account maken', subtitle:'Log in om door te gaan', username:'Gebruikersnaam', password:'Wachtwoord', confirm:'Wachtwoord bevestigen', signingIn:'Inloggen…', creating:'Account maken…', server:'Serververbinding', displayNamePlaceholder:'Hoe wil je worden weergegeven?' },
  pl: { signIn:'Zaloguj się', register:'Zarejestruj się', create:'Utwórz konto', subtitle:'Zaloguj się, aby kontynuować', username:'Nazwa użytkownika', password:'Hasło', confirm:'Potwierdź hasło', signingIn:'Logowanie…', creating:'Tworzenie konta…', server:'Połączenie z serwerem', displayNamePlaceholder:'Jak chcesz być wyświetlany?' },
  tr: { signIn:'Giriş yap', register:'Kayıt ol', create:'Hesap oluştur', subtitle:'Devam etmek için giriş yapın', username:'Kullanıcı adı', password:'Parola', confirm:'Parolayı doğrula', signingIn:'Giriş yapılıyor…', creating:'Hesap oluşturuluyor…', server:'Sunucu bağlantısı', displayNamePlaceholder:'Nasıl görünmek istersiniz?' },
  ru: { signIn:'Войти', register:'Регистрация', create:'Создать аккаунт', subtitle:'Войдите, чтобы продолжить', username:'Имя пользователя', password:'Пароль', confirm:'Подтвердите пароль', signingIn:'Вход…', creating:'Создание аккаунта…', server:'Подключение к серверу', displayNamePlaceholder:'Как вы хотите отображаться?' },
  ja: { signIn:'ログイン', register:'登録', create:'アカウントを作成', subtitle:'続行するにはログインしてください', username:'ユーザー名', password:'パスワード', confirm:'パスワードを確認', signingIn:'ログイン中…', creating:'作成中…', server:'サーバー接続', displayNamePlaceholder:'表示名を入力してください' },
  zh: { signIn:'登录', register:'注册', create:'创建账户', subtitle:'登录以继续', username:'用户名', password:'密码', confirm:'确认密码', signingIn:'正在登录…', creating:'正在创建…', server:'服务器连接', displayNamePlaceholder:'希望如何显示您的名字？' }
};
