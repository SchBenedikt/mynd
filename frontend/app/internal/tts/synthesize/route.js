...
const BACKEND_ORIGIN = (process.env.NEXT_PUBLIC_BACKEND_URL || 'http://127.0.0.1:5001').replace(/\/$/, '');
const BACKEND_TTS_URL = process.env.MYND_BACKEND_TTS_URL || `${BACKEND_ORIGIN}/api/tts/synthesize`;
